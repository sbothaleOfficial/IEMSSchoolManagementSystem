...
/// <summary>A document's bytes plus the info needed to open/save/share it.</summary>
public record SchoolDocumentFile(byte[] Data, string FileName, string ContentType);
